...
export declare class LoanService {
    ...
    getLoanReportCsv(page?: number, limit?: number, startDate?: string, endDate?: string, name?: string, loanId?: number, mobileNumber?: string, status?: string, emiId?: number, emiDueDate?: string): Promise<string>;
}
