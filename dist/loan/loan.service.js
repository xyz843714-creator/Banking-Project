...
let LoanService = class LoanService {
    ...
    async getLoanReport(page = 1, limit = 10, startDate, endDate, name, loanId, mobileNumber, status, emiId, emiDueDate) {
        ...
        const query = this.loanRepo.createQueryBuilder('loan')
            .leftJoin(user_entity_1.User, 'user', 'user.id = loan.userId')
    ...
    async getLoanReportCsv(page = 1, limit = 10, startDate, endDate, name, loanId, mobileNumber, status, emiId, emiDueDate) {
        const report = await this.getLoanReport(page, limit, startDate, endDate, name, loanId, mobileNumber, status, emiId, emiDueDate);
